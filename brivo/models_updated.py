...
class Livro(models.Model):
    ...
    subgenero = models.CharField(max_length=100, null=True, blank=True)  # NOVO: Campo subgênero
    ...
    ativo = models.BooleanField(default=True, help_text="Indica se o livro está ativo no sistema.")
