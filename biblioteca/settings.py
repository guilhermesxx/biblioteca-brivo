...
ALLOWED_HOSTS = os.environ.get('DJANGO_ALLOWED_HOSTS', '127.0.0.1,172.30.1.85,localhost,192.168.100.235,172.30.1.144,10.133.196.163,172.30.1.87').split(',')
...
EMAIL_TIMEOUT = 30
EMAIL_HOST_USER = ' '
EMAIL_HOST_PASSWORD = 'cqtbqjyaktaiztzi'
